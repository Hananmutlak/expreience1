...
})({"eLJEd":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 57107;
...
document.addEventListener('DOMContentLoaded', async ()=>{
    try {
        const experiences = await (0, _apiJs.getAllExperiences)();
        renderExperiences(experiences);
    } catch (error) {
        showError("Ett fel intr\xe4ffade vid h\xe4mtning av erfarenheter");
    }
});
function renderExperiences(experiences) {
    ...
    document.querySelectorAll('.delete-btn').forEach((btn)=>{
        btn.addEventListener('click', async (e)=>{
            ...
            try {
                await (0, _apiJs.deleteExperience)(id);
                e.target.closest('.experience-card').remove();
            } catch (error) {
                showError("Ett fel intr\xe4ffadde vid borttagning av erfarenheten");
            }
        });
    });
}
...
// جلب جميع الخبرات
parcelHelpers.export(exports, "getAllExperiences", ()=>getAllExperiences);
// إضافة خبرة جديدة
parcelHelpers.export(exports, "addExperience", ()=>addExperience);
// حذف خبرة
parcelHelpers.export(exports, "deleteExperience", ()=>deleteExperience);
...
},{}]},["eLJEd","lhpGb"], "lhpGb", "parcelRequire5bc3", {})

//# sourceMappingURL=experience.b828852a.js.map
